...
- (void)onTextMessageCellMenuClick:(SEL)arg1 { %log; %orig; }
...
- (struct CGRect)getMsgVisibleFrame { %log; struct CGRect r = %orig; return r; }
...
- (id)GetCurrentViewController { %log; id r = %orig; NSLog(@" = %@", r); return r; }
- (_Bool)isHiddenInputChangeButton { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
- (_Bool)canShowEnterpriseBrandEntry { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
- (_Bool)canShowLocation { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
- (_Bool)canShowFavEntry { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
...
- (_Bool)isAllowWxTalk { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
- (void)initAllowVoiceInput { %log; %orig; }
- (_Bool)isAllowVoiceInput { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
- (void)initAllowVoip { %log; %orig; }
- (_Bool)isAllowVoip { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
...
- (_Bool)shouldEnableKeyboardInteractivePop { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
...
- (_Bool)hasCardPkgEntry { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
- (_Bool)hasGroupPayEntry { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
- (_Bool)hasRedEnvelopesEntry { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
- (_Bool)hasTransferMoneyEntry { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
- (id)getMsgSendOpEntry { %log; id r = %orig; NSLog(@" = %@", r); return r; }
- (_Bool)hasServiceEntry { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
- (id)getServiceAppList { %log; id r = %orig; NSLog(@" = %@", r); return r; }
- (id)getAttachmentViewServiceAppList { %log; id r = %orig; NSLog(@" = %@", r); return r; }
...
- (_Bool)canShowFileBrowser { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
- (_Bool)canShowSight { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
- (void)onOpenTrackRoom:(unsigned int)arg1 { %log; %orig; }
- (_Bool)shouldShowOpenTrackRoom { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
...
- (_Bool)shouldInitWXEmoticonView { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
...
- (id)indexPathForCellKey:(id)arg1 { %log; id r = %orig; NSLog(@" = %@", r); return r; }
...
- (id)getHomePageBarButton { %log; id r = %orig; NSLog(@" = %@", r); return r; }
...
- (double)getSecurityBannerTipHeight { %log; double r = %orig; NSLog(@" = %f", r); return r; }
- (double)getAddFriendTipHeight { %log; double r = %orig; NSLog(@" = %f", r); return r; }
...
- (id)getTitleLableViewWithMaxWidth:(double)arg1 title:(id)arg2 { %log; id r = %orig; NSLog(@" = %@", r); return r; }
- (id)getTitleLableViewWithMaxWidth:(double)arg1 title:(id)arg2 fontSize:(double)arg3 { %log; id r = %orig; NSLog(@" = %@", r); return r; }
